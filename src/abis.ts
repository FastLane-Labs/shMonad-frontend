...
export const FastlaneOnlineAbi = [
  ...
  { inputs: [], name: 'FLOnlineControl_BalanceCheckFail', type: 'error' },
  { inputs: [], name: 'FLOnlineControl_BaselineSwap_BaselineCallFail', type: 'error' },
  { inputs: [], name: 'FLOnlineControl_BaselineSwap_NoBalanceIncrease', type: 'error' },
  { inputs: [], name: 'FLOnlineControl_PostOpsCall_InsufficientBaseline', type: 'error' },
  ...
  { inputs: [], name: 'FLOnlineInner_Swap_BaselineCallValueTooLow', type: 'error' },
  ...
  { inputs: [], name: 'FLOnlineInner_Swap_UserOpValueTooLow', type: 'error' },
  { inputs: [], name: 'FLOnlineOuter_FastOnlineSwap_NoFulfillment', type: 'error' },
  { inputs: [], name: 'FLOnlineOuter_ValidateSwap_GasLimitTooLow', type: 'error' },
  { inputs: [], name: 'FLOnlineOuter_ValidateSwap_InvalidSender', type: 'error' },
  { inputs: [], name: 'FLOnlineOuter_ValidateSwap_MsgValueTooLow', type: 'error' },
  ...
  { inputs: [], name: 'FLOnlineOuter_ValidateSwap_UserOpBaselineValueMismatch', type: 'error' },
  { inputs: [], name: 'FLOnlineOuter_ValidateSwap_UserOpValueTooLow', type: 'error' },
  { inputs: [], name: 'FLOnline_NotUnlocked', type: 'error' },
  ...
  {
    inputs: [],
    name: 'CARDANO_ENGINEER_THERAPY_FUND',
    outputs: [{ internalType: 'address', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [{ internalType: 'bytes32', name: 'solverOpHash', type: 'bytes32' }],
    name: 'getBidAmount',
    outputs: [{ internalType: 'uint256', name: 'bidAmount', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'isUserNonceValid',
    outputs: [{ internalType: 'bool', name: 'valid', type: 'bool' }],
    stateMutability: 'view',
    type: 'function',
  },
  { inputs: [], name: 'makeThogardsWifeHappy', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
